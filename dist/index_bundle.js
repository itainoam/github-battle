...
/***/ function(module, exports, __webpack_require__) {
	...
	var USER_DATA = {
	    name: "Itai",
	    username: "itainoam",
	    img: "https://avatars0.githubusercontent.com/u/12605830?v=3"
	};
	var Container = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement(HelloWorld, { name: this.props.name })
	        );
	    }
	});
	var ProfilePic = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            this.props.img,
	            ' dfsdf',
	            React.createElement('img', { src: this.props.img, style: { height: 100, width: 100 } })
	        );
	    }
	});

	var ProfilePick = React.createClass({
	    displayName: 'ProfilePick',
	...
	var Avatar = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            'div',
	            null,
	            React.createElement(ProfilePic, { img: this.props.img })
	        );
	    }
	});
